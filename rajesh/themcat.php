            ...
            <div class="col-md-5 no-padding lib-item" data-category="view">
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                          <a href="th1.php">  <img class="lib-img-show" src="images/th1.jpg"></a>
                        </div>
                        <div class="col-md-6">
     ...
     This park is famous for roller coaster
            ...
            <div class="col-md-5 no-padding lib-item" data-category="ui">
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <a href="th2.php"><img class="lib-img" src="images/th2.jpg"></a>
                        </div>
                        <div class="col-md-6">
                            <div class="lib-row lib-header">
Wonderland                                <div class="lib-header-seperator"></div>
             ...
             <div class="col-md-5 no-padding lib-item" data-category="view">
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <a href="th3.php"><img class="lib-img-show" src="images/th3.jpg"></a>
                        </div>
                        <div class="col-md-6">
                            <div class="lib-row lib-header">
MGP                                <div class="lib-header-seperator"></div>
            ...
            <div class="col-md-5 no-padding lib-item" data-category="ui">
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <a href="th4.php"><img class="lib-img" src="images/th4.jpg"></a>
                        </div>
                        <div class="col-md-6">
                            <div class="lib-row lib-header">
