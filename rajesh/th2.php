                ...
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                          ...
                          <a href="th2.php">  
                           <?php
                            $query=mysqli_query($conn,"SELECT * FROM att WHERE them='th2' AND att='att1'");
   ...
   echo '
                           ...
                           <div class="lib-row lib-desc">
                            ...
                            <form action="bookatt.php" method="post">
                                <input type="text" name="theme" id="hide" value="th2">
                ...
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <a href="th2.php">
<?php
                            $query=mysqli_query($conn,"SELECT * FROM att WHERE them='th2' AND att='att2'");
while ($res=mysqli_fetch_assoc($query)) {
  @$img=$res['img'];
  @$img = base64_encode($img);
  @$src= 'data: '.mime_content_type($img).';base64,'.$img;
                ...
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <a href="th3.php">
<?php
                            $query=mysqli_query($conn,"SELECT * FROM att WHERE them='th2' AND att='att3'");
while ($res=mysqli_fetch_assoc($query)) {
  @$img=$res['img'];
  @$img = base64_encode($img);
  @$src= 'data: '.mime_content_type($img).';base64,'.$img;
                ...
                <div class="lib-panel">
                    <div class="row box-shadow">
                        <div class="col-md-6">
                            <a href="th4.php">
<?php
                            $query=mysqli_query($conn,"SELECT * FROM att WHERE them='th2' AND att='att4'");
while ($res=mysqli_fetch_assoc($query)) {
  @$img=$res['img'];
  @$img = base64_encode($img);
  @$src= 'data: '.mime_content_type($img).';base64,'.$img;
