...
$quer=mysqli_query($conn,"UPDATE att SET named='$name',agelimit='$agelimit',price='$price',description='$desc',timeat='$time',img='$imagedata' WHERE att='$at' AND them='th2'");
if($quer){
    echo 'inserted';
}else{
    echo "not";
...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="adth2.php" method="post" enctype="multipart/form-data">
        <br style="clear:both">
